...
class _PodcastPageState extends State<PodcastPage> {
  ...
  Future<void> _initialize() async {
    try {
      ...
      // ----------------------------------------------------------
      // Création automatique de France Inter si absente
      // ----------------------------------------------------------
      ...
      if (franceInter == null) {
        ...
        franceInter = const PodcastRadio(
          name: 'France Inter',
      ...
      // ----------------------------------------------------------
      // Chargement des podcasts déjà présents en SQLite
      // ----------------------------------------------------------
  ...
  Future<void> _loadPodcasts() async {
    ...
    try {
      final podcasts = await widget.repository.getPodcastsForRadio(radio.id!);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(radio?.name ?? 'Podcasts'),
        actions: [
          if (_synchronizing)
            const Padding(
            ...
            IconButton(
              ...
              onPressed: _radio == null ? null : () => _synchronize(),
            ),
        ],
      ),
      body: Column(
